...
```
mkdir -p models/first_stage

mkdir -p models/ldm

wget https://drive.google.com/file/d/1tEoD62PATW3SLWKc0-mV-vb3XotsNjan/view?usp=sharing -P ./models/first_stage

wget https://drive.google.com/file/d/1nBh9Ya-dlcGvqr_6idE_4uvCPqtl9QqW/view?usp=sharing -P ./models/ldm
```
